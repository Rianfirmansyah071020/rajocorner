        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    <li>
                        <a href="index.php?page=pelanggan&aksi=detailPemesanan" aria-expanded="false">
                            <i class="fa-solid fa-dollar-sign"></i><span class="nav-text">Detail Pemesanan</span>
                        </a>

                        <a href="index.php?page=&aksi=home" aria-expanded="false">
                            <span class="nav-text">Kembali Ke Home</span>
                        </a>
                    </li>
                </ul>
            </div>
