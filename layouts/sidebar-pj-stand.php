        ...
        ***********************************-->
        <div class="nav-header bg-primary text-white">
            <div class="brand-logo">
                <a href="index.php?page=pjStand&aksi=dashboard">
                    ...
                    <ul class="clearfix">
                        ...
                        <li class="icons dropdown">
                            <div class="user-img c-pointer position-relative" data-toggle="dropdown">
                                ...
                                <img src="public/dataimage/pj_stand/<?= $_SESSION['foto'] ?>" height="40" width="40"
                                    alt="">
                            </div>
        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    <li>
                        <a href="index.php?page=pjStand&aksi=dashboard" aria-expanded="false">
                            <i class="fa-solid fa-gauge "></i><span class="nav-text">Dashboard</span>
                        </a>
                    </li>
                    <li>
                        <a href="index.php?page=pjStand&aksi=menu" aria-expanded="false">
                            <i class="fa-solid fa-list"></i><span class="nav-text">Data Menu</span>
                        </a>
                    </li>
                    <li>
                        <a href="index.php?page=pjStand&aksi=konfirmasiPesan" aria-expanded="false">
                            <i class="fa-solid fa-handshake"></i><span class="nav-text">Konfirmasi Pemesanan</span>
                        </a>
                    </li>
                </ul>
            </div>
