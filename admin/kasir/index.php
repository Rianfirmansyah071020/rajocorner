...
<div class="content-body">
    ...
    <div class="row page-titles mx-0 bg-primary text-white">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Dashboard / Kelola Data Kasir</li>
            </ol>
        </div>
    </div>
    <!-- row -->
    <div class="container-fluid">
        ...
        <div class="row p-3 mt-2 mb-2 card shadow ">
            <div class="col-lg-4 col-xl-4 col-md-12 col-sm-12">
                <h5>Halaman Kelola Data Kasir</h5>
            </div>
            <div class="col-lg-4 col-xl-4 col-md-12 col-sm-12">
        ...
        <?php 
            // kode admin otomatis
            $kasirById = mysqli_query($conn, "SELECT MAX(id_kasir) AS ID FROM kasir");
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content p-4">
                    <div class="modal-header">
                        <h5 class="modal-title">Form Tambah Data Kasir</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="id_kasir" value="<?= $kodeAuto ?>"
                                                class="form-control" placeholder="ID Kasir" required readonly>
                                        </div>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered zero-configuration">
                        ...
                        <tbody>
                            <?php 
                                $dataKasirAll = mysqli_query($conn, "SELECT * FROM kasir");
                                $no = 1;
                                ?>

                            <?php foreach ($dataKasirAll as $row) { ?>
                            <tr>
                                ...
                                <td class="row justify-content-center">
                                    <a href="index.php?page=admin&aksi=detailKasir&id=<?= $row['id_kasir'] ?>"
                                        class="btn btn-warning"
                                        onclick="return confirm('Apakah anda ingin melihat detail data ini ?')">Detail</a>

                                    <a href="index.php?page=admin&aksi=ubahKasir&id=<?= $row['id_kasir'] ?>"
                                        class="btn btn-info ubah"
                                        onclick="return confirm('Apakah anda ingin mengubah data ini ?')">Ubah</a>

                                    <a href="index.php?page=admin&aksi=hapusKasir&id=<?= $row['id_kasir'] ?>"
