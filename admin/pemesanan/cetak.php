...
<div class="container mt-5" style="font-family: monospace;">
    ...
    <?php                                 
                                ...
                                $dataPemesananAll = mysqli_query($conn, "SELECT sum(pemesanan.total) as total_all, pemesanan.id_pemesanan as id_pemesanan, pelanggan.nama_lengkap as nama_lengkap, stand.nama_stand as nama_stand, menu.nama_menu as nama_menu, meja.kode_meja as kode_meja, pemesanan.tanggal_pesan as tanggal_pesan, pemesanan.jumlah_pesan as jumlah_pesan, pemesanan.total as total, pemesanan.status_pesan status_pesan FROM pemesanan INNER JOIN pelanggan ON pemesanan.id_pelanggan=pelanggan.id_pelanggan INNER JOIN menu ON pemesanan.id_menu=menu.id_menu INNER JOIN stand ON pemesanan.id_stand=stand.id_stand INNER JOIN meja ON pemesanan.id_meja=meja.id_meja WHERE tanggal_pesan ='$tglHariIni'");
                                $no = 1;
                                ?>
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="basic-list-group justify-content-center">
                     ...
                     $total = mysqli_query($conn, "SELECT sum(total) as total FROM pemesanan WHERE tanggal_pesan ='$tglHariIni'");
