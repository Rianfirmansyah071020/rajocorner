    ...
    <div class="container-fluid">
        <div class="row p-3 mt-2 mb-2 card shadow ">
            <div class="col-lg-4 col-xl-4 col-md-12 col-sm-12">
                <h5>Halaman Ubah Data admin <span class="text-info"> <?= $adminById['nama_lengkap']; ?> </span></h5>
            </div>
            <div class="col-lg-4 col-xl-4 col-md-12 col-sm-12">
    ...
    <div class="container-fluid">
        <div class="row justify-content-center p-3">
            ...
            <div class="card col-lg-4 col-xl-4 col-md-12 col-sm-12 p-3">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="text" name="id_admin" value="<?= $adminById['id_admin'] ?>" class="form-control"
                            placeholder="ID Admin" required readonly>
                    </div>

                    <!-- input username -->
                    <div class="form-group">
                        <input type="hidden" name="usernameLama" value="<?= $adminById['username']; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="passwordLama" value="<?= $adminById['password']; ?>">
                    </div>
            ...
            <div class="card col-lg-4 col-xl-4 col-md-12 col-sm-12 p-3">
                <!-- input nama lengkap -->
                <div class="form-group">
                    <input type="text" name="nama_lengkap" value="<?= $adminById['nama_lengkap']; ?>"
                ...
                <div class="form-group">
                    <select name="jekel" id="jekel" class="form-control">
                        ...
                        <option value="laki-laki" <?php if($adminById['jekel'] == 'laki-laki')  echo "selected"?>>
                            Laki
                            - Laki</option>
                        <option value="perempuan" <?php if($adminById['jekel'] == 'perempuan')  echo "selected"?>>
                            Perempuan</option>
                    </select>
                </div>
                ...
                <!-- input nomor hp -->
                <div class="form-group">
                    <input type="text" name="nomor_hp" class="form-control" value="<?= $adminById['nomor_hp']; ?>"
                ...
                <div class="mt-3 row justify-content-end p-3">
                    ...
                    <a href="index.php?page=admin&aksi=admin" class="btn btn-success m-1">kembali</a>
                </div>
            </div>
            </form>
        </div>
